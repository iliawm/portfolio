...
const windowsFont = IBM_Plex_Sans({
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${geist.variable} ${windowsFont.variable} h-full antialiased`}
      suppressHydrationWarning
    >
      <body className="min-h-full flex flex-col font-(family-name:--font-windows)">
        <div className="w-full h-full fixed z-90 md:hidden flex flex-col items-center justify-center top-0 left-0 bg-black text-white px-20 gap-5">
          ...
          <div>
            ...
            >
              ...
              />
              <path
                d="M5 85 L135 85 L120 95 L20 95 Z"
                fill="#4A5568"
              />
              <line
                x1="100"
